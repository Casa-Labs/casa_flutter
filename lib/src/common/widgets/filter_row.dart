...
class FilterRow extends StatelessWidget {
  ...
  final List<ProductModelFilter>? sizedList;
    FilterRow({super.key,this.brandList, this.productList, this.colorList, this.sizedList});
  ...
  void _showTextInputDialog(BuildContext context, List<ProductModelFilter> children, String filterName ) async {
    showDialog(
      context: context,
          ...
          builder: (BuildContext context, StateSetter setState) {
            return AlertDialog(
              ...
              content: SizedBox(
                ...
                child: CommonFilterDialog(children: children,filterName: filterName,),
              ),
            );
          },
        );
  ...
  _filterItem(String filterName, List<ProductModelFilter> children,BuildContext context){
    return  InkWell(
      splashColor: CColor.transparent,
      highlightColor: CColor.transparent,
      onTap: () {
